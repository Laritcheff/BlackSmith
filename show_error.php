...
<html>
 ...
 <body>
  <div id="header"><h1>Все накрылось пиздой!!!</h1></div>
  <div id="example">Извините</div>

  <div id="content">
    <h1>Нам нихрена не жаль...</h1>
    <p><img src="images/error.jpg" class="error">...но все наклылось пиздой. <span class="error_message"><?php echo $user_error;?> </span></p>
